use crate::{
    ...
    handlers::{
        ...
        reset_rgb_focus_calibration, sec_mcu_reboot, service, skip_operator_qr,
        slot_switch, speed_test, thermal_cam_recalibration, update_versions, wifi_add,
        wifi_connect, wifi_ip, wifi_list, wifi_remove, wifi_scan, wipe_downloads,
    },
...
pub async fn run(deps: Deps) -> Result<()> {
    ...
    let job_handler = JobHandler::builder()
        ...
        .parallel("skip_operator_qr", skip_operator_qr::handler)
