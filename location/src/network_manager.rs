...
impl NetworkManager {
    ...
    pub async fn cleanup_expired(&self) -> usize {
        ...
        if removed_count > 0 {
            info!(
                ...
                remaining = networks.len(),
                "Cleaned up expired networks"
            );
        }
    ...
    pub async fn get_current_networks(&self) -> Vec<WifiNetwork> {
        ...
        debug!(
            count = result.len(),
            "Retrieved current non-expired networks"
        );
        result
    }
...
mod tests {
    ...
    fn test_update_networks() {
        ...
        rt.block_on(async {
            ...
            let test2 = current
                .iter()
                .find(|n| n.bssid == "00:11:22:33:44:66")
                .unwrap();
    ...
    fn test_cleanup_expired() {
        ...
        rt.block_on(async {
            ...
            let new_networks =
                vec![create_test_network("Test3", "00:11:22:33:44:77", -70)];
