...
trait Manager {
    /// AbandonScope method
    fn abandon_scope(&self, arg_1: &str) -> zbus::Result<()>;
    ...
    /// CancelJob method
    fn cancel_job(&self, arg_1: u32) -> zbus::Result<()>;

    /// CleanUnit method
    fn clean_unit(&self, arg_1: &str, arg_2: &[&str]) -> zbus::Result<()>;
    ...
    /// GetJob method
    fn get_job(&self, arg_1: u32) -> zbus::Result<zbus::zvariant::OwnedObjectPath>;
    ...
    /// GetUnit method
    fn get_unit(&self, arg_1: &str) -> zbus::Result<zbus::zvariant::OwnedObjectPath>;
    ...
    fn get_unit_processes(
        &self,
        arg_1: &str,
    ) -> zbus::Result<Vec<(String, u32, String)>>;
    ...
    /// KillUnit method
    fn kill_unit(&self, arg_1: &str, arg_2: &str, arg_3: i32) -> zbus::Result<()>;
    ...
    /// LoadUnit method
    fn load_unit(&self, arg_1: &str) -> zbus::Result<zbus::zvariant::OwnedObjectPath>;

    /// LookupDynamicUserByName method
    fn lookup_dynamic_user_by_name(&self, arg_1: &str) -> zbus::Result<u32>;

    /// LookupDynamicUserByUID method
    #[zbus(name = "LookupDynamicUserByUID")]
    fn lookup_dynamic_user_by_uid(&self, arg_1: u32) -> zbus::Result<String>;
    ...
    /// RefUnit method
    fn ref_unit(&self, arg_1: &str) -> zbus::Result<()>;
    ...
    fn set_environment(&self, arg_1: &[&str]) -> zbus::Result<()>;

    /// SetExitCode method
    fn set_exit_code(&self, arg_1: u8) -> zbus::Result<()>;
    ...
    /// SwitchRoot method
    fn switch_root(&self, arg_1: &str, arg_2: &str) -> zbus::Result<()>;
    ...
    /// UnrefUnit method
    fn unref_unit(&self, arg_1: &str) -> zbus::Result<()>;
    ...
    fn unset_environment(&self, arg_1: &[&str]) -> zbus::Result<()>;
    ...
    /// Reloading signal
    #[zbus(signal)]
    fn reloading(&self, arg_1: bool) -> zbus::Result<()>;
