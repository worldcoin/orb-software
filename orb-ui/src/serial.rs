...
impl Serial {
    ...
    pub fn spawn(
        mut input_rx: mpsc::Receiver<orb_mcu_messaging::mcu_message::Message>,
    ) -> Result<()> {
    ...
    fn write_message(
        w: &mut impl Write,
        message: orb_mcu_messaging::mcu_message::Message,
    ) -> Result<()> {
        let message = orb_mcu_messaging::McuMessage {
            version: orb_mcu_messaging::Version::Version0 as i32,
